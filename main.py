...
import logging
from DataSet_us import OurData
# from DataSet_ours import load_data
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='p2t_large', type=str, metavar='MODEL',
    ...
    parser.add_argument('--eval_epoch', default=5, type=int, help='Do evaluation per x epoches')
...
def main(args):
    ...
    path_dir = '.\\DataSets'
    dataset_train, dataset_val = OurData(path_dir)
    args.nb_classes = 22
